...
export const DependentQueriesPage = ({ email }) => {
    const { data: user, isLoading: isLoadingUsers } = useQuery(['user', email], () => fetchUserByEmail(email))
    ...
    const { data: channel, isLoading: isLoadingUsersChannels } = useQuery(['channel', channelId], () => fetchCoursesByChannelId(channelId), {
